/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 56bf4ac439021565fc7e2a50b3ac2a39)
...
declare namespace Cloudflare {
	...
	interface Env {
		DND_WEBSOCKETS: Fetcher /* dnd-websockets */;
		ASSETS: Fetcher;
	}
}
